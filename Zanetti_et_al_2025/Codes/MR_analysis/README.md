...
3. Finally, the "***Plots.R***" script generates forest plots to visually represent the final results for both women and men together and Venn diagrams to represent protein shared between outcomes.
